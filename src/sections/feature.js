...
const data = [
  ...
  },
  {
    id: 2,
    imgSrc: Partnership,
    altText: 'Skilled and Licensed Therapists',
    title: 'Skilled and Licensed Therapists',
    text:
  ...
  },
  {
    id: 3,
    imgSrc: Subscription,
    altText: 'Tranquil Atmosphere and Ambiance',
    title: 'Tranquil Atmosphere and Ambiance',
    text:
      'Let’s just get this out of the way - there will always be a kit version of Edu flow. Paid subscriptions allow us to continue helping learners around the world.',
  },
  {
    id: 4,
    imgSrc: Support,
    altText: 'Exceptional Customer Service',
